...
.method private onAnimateUpdated(Landroid/animation/ValueAnimator;)V
    ...
    .line 80
    iget-object p1, p0, Lcom/rd/animation/type/ThinWormAnimation;->listener:Lcom/rd/animation/controller/ValueController$UpdateListener;
...
.method public progress(F)Lcom/rd/animation/type/ThinWormAnimation;
    ...
    .line 87
    iget-object v0, p0, Lcom/rd/animation/type/ThinWormAnimation;->animator:Landroid/animation/Animator;

    if-eqz v0, :cond_4

    .line 88
    iget-wide v0, p0, Lcom/rd/animation/type/ThinWormAnimation;->animationDuration:J
    ...
    .line 89
    iget-object p1, p0, Lcom/rd/animation/type/ThinWormAnimation;->animator:Landroid/animation/Animator;
    ...
    .line 92
    iget-object v3, p0, Lcom/rd/animation/type/ThinWormAnimation;->animator:Landroid/animation/Animator;
...
.method public with(IIIZ)Lcom/rd/animation/type/WormAnimation;
    ...
    iput-object v2, v7, Lcom/rd/animation/type/ThinWormAnimation;->animator:Landroid/animation/Animator;

    .line 29
    iput v0, v7, Lcom/rd/animation/type/ThinWormAnimation;->coordinateStart:I

    move/from16 v2, p2

    .line 30
    iput v2, v7, Lcom/rd/animation/type/ThinWormAnimation;->coordinateEnd:I

    .line 32
    iput v8, v7, Lcom/rd/animation/type/ThinWormAnimation;->radius:I

    .line 33
    iput-boolean v1, v7, Lcom/rd/animation/type/ThinWormAnimation;->isRightSide:Z
    ...
    .line 36
    iput v2, v7, Lcom/rd/animation/type/ThinWormAnimation;->rectLeftEdge:I

    add-int/2addr v0, v8

    .line 37
    iput v0, v7, Lcom/rd/animation/type/ThinWormAnimation;->rectRightEdge:I

    .line 39
    iget-object v0, v7, Lcom/rd/animation/type/ThinWormAnimation;->value:Lcom/rd/animation/data/type/ThinWormAnimationValue;

    iget v2, v7, Lcom/rd/animation/type/ThinWormAnimation;->rectLeftEdge:I

    invoke-virtual {v0, v2}, Lcom/rd/animation/data/type/ThinWormAnimationValue;->setRectStart(I)V

    .line 40
    iget-object v0, v7, Lcom/rd/animation/type/ThinWormAnimation;->value:Lcom/rd/animation/data/type/ThinWormAnimationValue;

    iget v2, v7, Lcom/rd/animation/type/ThinWormAnimation;->rectRightEdge:I

    invoke-virtual {v0, v2}, Lcom/rd/animation/data/type/ThinWormAnimationValue;->setRectEnd(I)V
    ...
    .line 43
    invoke-virtual {v7, v1}, Lcom/rd/animation/type/ThinWormAnimation;->createRectValues(Z)Lcom/rd/animation/type/WormAnimation$RectValues;

    move-result-object v10

    .line 44
    iget-wide v0, v7, Lcom/rd/animation/type/ThinWormAnimation;->animationDuration:J
    ...
    iget v2, v10, Lcom/rd/animation/type/WormAnimation$RectValues;->toX:I
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/rd/animation/type/ThinWormAnimation;->createWormAnimator(IIJZLcom/rd/animation/data/type/WormAnimationValue;)Landroid/animation/ValueAnimator;
    ...
    .line 54
    invoke-direct {v7, v2, v1, v3, v4}, Lcom/rd/animation/type/ThinWormAnimation;->createHeightAnimator(IIJ)Landroid/animation/ValueAnimator;

    move-result-object v5

    .line 55
    invoke-direct {v7, v1, v2, v3, v4}, Lcom/rd/animation/type/ThinWormAnimation;->createHeightAnimator(IIJ)Landroid/animation/ValueAnimator;
    ...
    .line 58
    iget-object v2, v7, Lcom/rd/animation/type/ThinWormAnimation;->animator:Landroid/animation/Animator;
