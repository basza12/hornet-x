.class public Lcom/pubnub/api/endpoints/presence/Leave;
...
.method public constructor <init>(Lcom/pubnub/api/PubNub;Lcom/pubnub/api/managers/TelemetryManager;Lcom/pubnub/api/managers/RetrofitManager;)V
    ...
    iput-object p1, p0, Lcom/pubnub/api/endpoints/presence/Leave;->channels:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/pubnub/api/endpoints/presence/Leave;->channelGroups:Ljava/util/List;
...
# virtual methods
.method public channelGroups(Ljava/util/List;)Lcom/pubnub/api/endpoints/presence/Leave;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/pubnub/api/endpoints/presence/Leave;"
        }
    .end annotation
...
.method public channels(Ljava/util/List;)Lcom/pubnub/api/endpoints/presence/Leave;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected bridge synthetic createResponse(Lretrofit2/Response;)Ljava/lang/Object;
    ...
    .line 21
    invoke-virtual {p0, p1}, Lcom/pubnub/api/endpoints/presence/Leave;->createResponse(Lretrofit2/Response;)Ljava/lang/Boolean;
...
.method protected doWork(Ljava/util/Map;)Lretrofit2/Call;
    ...
    .line 48
    iget-object v0, p0, Lcom/pubnub/api/endpoints/presence/Leave;->channelGroups:Ljava/util/List;
    ...
    .line 49
    iget-object v1, p0, Lcom/pubnub/api/endpoints/presence/Leave;->channelGroups:Ljava/util/List;
    ...
    .line 52
    :cond_0
    iget-object v0, p0, Lcom/pubnub/api/endpoints/presence/Leave;->channels:Ljava/util/List;
    ...
    .line 58
    :goto_0
    invoke-virtual {p0}, Lcom/pubnub/api/endpoints/presence/Leave;->getRetrofit()Lcom/pubnub/api/managers/RetrofitManager;
    ...
    invoke-virtual {p0}, Lcom/pubnub/api/endpoints/presence/Leave;->getPubnub()Lcom/pubnub/api/PubNub;
    ...
    invoke-interface {v1, v2, v0, p1}, Lcom/pubnub/api/services/PresenceService;->leave(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lretrofit2/Call;
...
.method protected getOperationType()Lcom/pubnub/api/enums/PNOperationType;
    ...
    .line 68
    sget-object v0, Lcom/pubnub/api/enums/PNOperationType;->PNUnsubscribeOperation:Lcom/pubnub/api/enums/PNOperationType;
