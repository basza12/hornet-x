...
.method private hasAppDefinedMarketplaceChanged()Z
    ...
    .line 411
    iget-boolean v1, p0, Lcom/amazon/device/ads/Configuration;->isAppDefinedMarketplaceSet:Z
    ...
    .line 415
    iget-object v1, p0, Lcom/amazon/device/ads/Configuration;->appDefinedMarketplace:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v3, v4}, Lcom/amazon/device/ads/Settings;->putLongWithNoFlush(Ljava/lang/String;J)V
    ...
    invoke-virtual {v0, v1, v3}, Lcom/amazon/device/ads/Settings;->putStringWithNoFlush(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected createWebRequest()Lcom/amazon/device/ads/WebRequest;
    ...
    const-string v2, "debug.aaxConfigParams"

    invoke-virtual {v1, v2, v4}, Lcom/amazon/device/ads/DebugProperties;->getDebugPropertyAsString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method protected fetchConfigurationOnBackgroundThread()V
    ...
    const-string v1, "In configuration fetcher background thread."

    invoke-virtual {v0, v1}, Lcom/amazon/device/ads/MobileAdsLogger;->d(Ljava/lang/String;)V

    .line 553
    iget-object v0, p0, Lcom/amazon/device/ads/Configuration;->permissionChecker:Lcom/amazon/device/ads/PermissionChecker;
    ...
    .line 594
    invoke-virtual {v6}, Lcom/amazon/device/ads/Configuration$ConfigOption;->getResponseKey()Ljava/lang/String;
    ...
    .line 596
    invoke-virtual {v6}, Lcom/amazon/device/ads/Configuration$ConfigOption;->getAllowEmpty()Z
    ...
    .line 602
    :cond_2
    iget-object v7, p0, Lcom/amazon/device/ads/Configuration;->settings:Lcom/amazon/device/ads/Settings;

    invoke-static {v6}, Lcom/amazon/device/ads/Configuration$ConfigOption;->access$000(Lcom/amazon/device/ads/Configuration$ConfigOption;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v7, v6}, Lcom/amazon/device/ads/Settings;->removeWithNoFlush(Ljava/lang/String;)V

    goto :goto_1

    .line 606
    :cond_3
    invoke-direct {p0, v6, v0}, Lcom/amazon/device/ads/Configuration;->writeSettingFromConfigOption(Lcom/amazon/device/ads/Configuration$ConfigOption;Lorg/json/JSONObject;)V
    ...
    .line 609
    :cond_4
    sget-object v3, Lcom/amazon/device/ads/Configuration$ConfigOption;->DEBUG_PROPERTIES:Lcom/amazon/device/ads/Configuration$ConfigOption;
    ...
    .line 611
    iget-object v3, p0, Lcom/amazon/device/ads/Configuration;->debugProperties:Lcom/amazon/device/ads/DebugProperties;
    ...
    invoke-virtual {v3, v4}, Lcom/amazon/device/ads/DebugProperties;->overwriteDebugProperties(Lorg/json/JSONObject;)V
    ...
    invoke-static {v4}, Lcom/amazon/device/ads/Configuration$ConfigOption;->access$000(Lcom/amazon/device/ads/Configuration$ConfigOption;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/amazon/device/ads/Settings;->removeWithNoFlush(Ljava/lang/String;)V

    .line 616
    iget-object v3, p0, Lcom/amazon/device/ads/Configuration;->debugProperties:Lcom/amazon/device/ads/DebugProperties;

    invoke-virtual {v3}, Lcom/amazon/device/ads/DebugProperties;->clearDebugProperties()V
    ...
    const-string v3, "The configuration value must be present and not null."
    ...
    invoke-static {v3, v4}, Lcom/amazon/device/ads/NumberUtils;->convertToMillisecondsFromSeconds(J)J
    ...
    .line 633
    iget-object v3, p0, Lcom/amazon/device/ads/Configuration;->logger:Lcom/amazon/device/ads/MobileAdsLogger;

    const-string v4, "Unexpected error during parsing: %s"
    ...
    invoke-virtual {v3, v4, v1}, Lcom/amazon/device/ads/MobileAdsLogger;->e(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method protected shouldFetch()Z
    ...
    invoke-virtual {v0, v2, v3}, Lcom/amazon/device/ads/Settings;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v2, v4, v5}, Lcom/amazon/device/ads/Settings;->getLong(Ljava/lang/String;J)J
    ...
    const-string v2, "config-ttl"

    const-wide/32 v10, 0xa4cb800

    invoke-virtual {v0, v2, v10, v11}, Lcom/amazon/device/ads/Settings;->getLong(Ljava/lang/String;J)J
    ...
    const-string v2, "amzn-ad-iu-last-checkin"

    invoke-virtual {v0, v2, v4, v5}, Lcom/amazon/device/ads/Settings;->getWrittenLong(Ljava/lang/String;J)J
    ...
    invoke-virtual {v2, v4, v3}, Lcom/amazon/device/ads/Settings;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v0, v2, v4}, Lcom/amazon/device/ads/DebugProperties;->getDebugPropertyAsBoolean(Ljava/lang/String;Ljava/lang/Boolean;)Ljava/lang/Boolean;
