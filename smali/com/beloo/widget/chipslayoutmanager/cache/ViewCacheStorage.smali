...
# static fields
.field private static final SIZE_MAX_CACHE:I = 0x3e8
...
.method public isPositionStartsRow(I)Z
    .locals 1
...
.method public purgeCacheToPosition(I)V
    .locals 3
    ...
    .line 108
    :cond_0
    sget-object v0, Lcom/beloo/widget/chipslayoutmanager/cache/ViewCacheStorage;->TAG:Ljava/lang/String;
...
.method public setCachingEnabled(Z)V
    ...
    const-string v1, "caching enabled"

    goto :goto_0

    :cond_1
    const-string v1, "caching disabled"
...
.method public setMaxCacheSize(I)V
    ...
    .line 32
    iput p1, p0, Lcom/beloo/widget/chipslayoutmanager/cache/ViewCacheStorage;->maxCacheSize:I
