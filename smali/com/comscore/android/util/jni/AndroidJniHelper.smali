...
.method private a()V
    ...
    invoke-virtual {v0}, Lcom/comscore/Configuration;->isVce()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Lcom/comscore/android/vce/Vce;->isEnabled()Z
    ...
    check-cast v1, Lcom/comscore/PublisherConfiguration;

    iget-object v2, p0, Lcom/comscore/android/util/jni/AndroidJniHelper;->a:Landroid/content/Context;

    invoke-static {v2}, Lcom/comscore/android/vce/Vce;->getSharedInstance(Landroid/content/Context;)Lcom/comscore/android/vce/Vce;

    move-result-object v2

    invoke-virtual {v1}, Lcom/comscore/PublisherConfiguration;->getPublisherId()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v2, v1}, Lcom/comscore/android/vce/Vce;->addPublisherId(Ljava/lang/String;)V
...
.method private b()V
    ...
    invoke-virtual {v0}, Lcom/comscore/Configuration;->getPartnerConfigurations()Ljava/util/List;
    ...
    check-cast v1, Lcom/comscore/PartnerConfiguration;
    ...
    invoke-virtual {v1}, Lcom/comscore/PartnerConfiguration;->getPartnerId()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v2, v1}, Lcom/comscore/android/vce/Vce;->addPartnerId(Ljava/lang/String;)V
...
.method protected getPlatformLabels(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lcom/comscore/android/CommonUtils;->getApplicationResolution(Landroid/content/Context;)Ljava/lang/String;
...
.method public onConfigurationChanged(I)V
    ...
    invoke-virtual {p1}, Lcom/comscore/Configuration;->isVce()Z
    ...
    :pswitch_3
    invoke-direct {p0}, Lcom/comscore/android/util/jni/AndroidJniHelper;->a()V

    return-void

    :pswitch_4
    invoke-direct {p0}, Lcom/comscore/android/util/jni/AndroidJniHelper;->b()V
...
.method public onCoreStarted()V
    ...
    invoke-static {v0}, Lcom/comscore/android/vce/Vce;->getSharedInstance(Landroid/content/Context;)Lcom/comscore/android/vce/Vce;

    move-result-object v0

    invoke-virtual {v0}, Lcom/comscore/android/vce/Vce;->discoverAndTrackAds()V
...
.method public subscribeToForegroundNotification()Z
    ...
    new-instance v0, Lcom/comscore/android/util/BackgroundManager;

    iget-object v1, p0, Lcom/comscore/android/util/jni/AndroidJniHelper;->a:Landroid/content/Context;

    check-cast v1, Landroid/app/Application;

    invoke-direct {v0, v1}, Lcom/comscore/android/util/BackgroundManager;-><init>(Landroid/app/Application;)V

    iput-object v0, p0, Lcom/comscore/android/util/jni/AndroidJniHelper;->b:Lcom/comscore/android/util/BackgroundManager;

    iget-object v0, p0, Lcom/comscore/android/util/jni/AndroidJniHelper;->b:Lcom/comscore/android/util/BackgroundManager;

    invoke-virtual {v0}, Lcom/comscore/android/util/BackgroundManager;->register()V
